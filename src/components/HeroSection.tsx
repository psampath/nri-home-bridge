    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        <div className="max-w-3xl mx-auto animate-fade-up">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 font-open-sans">
            Your Trusted Partner for Property Management in India
          </h1>
          <p className="text-xl md:text-2xl text-gray-200 mb-8 font-open-sans">
            From the US to Hyderabad, we bridge the gap—handling your properties with care, so you don't have to worry.
          </p>
          ...
          <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
            ...
            <p className="text-white text-sm md:text-base">
              Founded by an NRI who lived in the US for 12 years
            </p>
          </div>
        </div>
      </div>
